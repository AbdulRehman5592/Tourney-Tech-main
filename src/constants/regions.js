...
export const GEOGRAPHIC_REGIONS = [
  { code: "00", name: "Other" },
  { code: "01", name: "NY-NJ-DE" },
  { code: "02", name: "DMV / BALTIMORE" },
  { code: "03", name: "Detroit" },
  { code: "04", name: "Atlanta" },
  { code: "05", name: "Columbus" },
  { code: "06", name: "Cincinnati" },
  { code: "07", name: "Chicago" },
  { code: "08", name: "Dallas" },
  { code: "09", name: "Austin" },
  { code: "10", name: "Houston" },
  { code: "11", name: "San Antonio" },
  { code: "12", name: "New Orleans" },
  { code: "13", name: "Las Vegas" },
  { code: "14", name: "7-Cities / Richmond" },
  { code: "15", name: "Los Angeles" },
  { code: "16", name: "Florida" },
  { code: "17", name: "CT/MAS/NH/VT (NE)" },
  { code: "18", name: "Birmingham" },
  { code: "19", name: "PHIL / PA CITIES" },
];
