...
export const regionCitiesMap = {
  "NY/NJ": ["New York City", "Newark"],
  "PHIL / PA CITIES / DE": ["Philadelphia", "Pittsburgh", "Allentown", "Wilmington"],
  "CT/MAS/NH/VT (NE)": ["Hartford", "Boston", "Concord", "Burlington"],
  "DMV/BAL": ["Washington DC", "Baltimore", "Arlington"],
  "7-Cities / Richmond": ["Norfolk", "Virginia Beach", "Richmond"],
  "Detroit, MI": ["Downtown", "Dearborn", "Southfield"],
  "Atlanta, GA": ["Downtown", "Midtown", "Buckhead"],
  "Birmingham, AL": ["Hoover", "Homewood", "Mountain Brook"],
  "Columbus, OH": ["Downtown", "Dublin", "Westerville"],
  Florida: ["Miami", "Orlando", "Tampa", "Jacksonville"],
  "Cincinnati, OH": ["Downtown", "Hyde Park", "Over-the-Rhine"],
  "Chicago, IL": ["Downtown", "Evanston", "Oak Park"],
  "Dallas, TX": ["Irving", "Plano", "Arlington"],
  "Austin, TX": ["Downtown", "Round Rock", "Cedar Park"],
  "Houston, TX": ["Sugar Land", "Katy", "The Woodlands"],
  "San Antonio, TX": ["Downtown", "Alamo Heights", "Stone Oak"],
  "New Orleans, LA": ["French Quarter", "Garden District", "Uptown"],
  "Los Angeles, CA": ["Hollywood", "Santa Monica", "Burbank"],
  "Las Vegas, NV": ["Summerlin", "Henderson", "Paradise"],
  Other: ["Other Region"],
};
